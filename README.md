# @hishprorg/qui-veritatis

[![npm version](https://badge.fury.io/js/@hishprorg/qui-veritatis.svg)](https://badge.fury.io/js/@hishprorg/qui-veritatis)
[![downloads count](https://img.shields.io/npm/dt/@hishprorg/qui-veritatis.svg)](https://www.npmjs.com/package/@hishprorg/qui-veritatis)
[![github-ci](https://github.com/hishprorg/qui-veritatis/actions/workflows/testing.yml/badge.svg)](https://github.com/hishprorg/qui-veritatis/actions/workflows/testing.yml)
...
Next, install `@hishprorg/qui-veritatis`:

```bash
npm install -D @hishprorg/qui-veritatis
```
